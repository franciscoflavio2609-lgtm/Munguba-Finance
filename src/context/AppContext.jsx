...
const emptyState = (userId) => ({
  ...
  xp: 0, user: null, session: null, achievements: [], onboarded: false, budgetConfigured: false,
  notifications: [
...
function reducer(state, action) {
  switch (action.type) {
    ...
    case 'ADD_XP': return { ...state, xp: state.xp + (action.payload || 0) }
    ...
    case 'SET_ONBOARDED': return { ...state, onboarded: true }
    case 'SET_BUDGET_CONFIGURED': return { ...state, budgetConfigured: true }
