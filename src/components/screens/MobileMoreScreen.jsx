  ...
  return (
    <div style={{animation:'vIn .26s ease', paddingBottom:80}}>
      ...
      <div style={{background:'#fff', borderRadius:20, overflow:'hidden', marginBottom:14, boxShadow:'0 1px 4px rgba(4,77,44,.08)', border:'1px solid rgba(10,138,82,.1)'}}>
        ...
        <MenuItem icon="🧮" label="Calculadoras" color="#0E7490" onClick={()=>onNav('calc')}/>
        <MenuItem icon="📡" label="Radar Econômico" color="#7C3AED" onClick={()=>onNav('radar')}/>
        <MenuItem icon="🏆" label="Conquistas" color="#D97706" onClick={()=>onNav('ach')}/>
        <MenuItem icon="👨‍👩‍👧" label="Família" color="#EC4899" onClick={()=>onNav('fam')}/>
